...
var knownUnresolvedWireCalls = map[string]wireCallExclusion{
	...
	"remote_machine_identities.go:326":      urlValuesEntry(),
	"remote_machine_identities.go:675":      urlValuesEntry(),
	"remote_memberships.go:194":             urlValuesEntry(),
	"remote_memberships.go:213":             urlValuesEntry(),
	"remote_memberships.go:230":             urlValuesEntry(),
	"remote_memberships.go:269":             urlValuesEntry(),

...
var knownUnresolvedWireCalls = map[string]wireCallExclusion{
	...
	"remote_access_review_campaigns.go:216": urlValuesEntry(),
	"remote_access_review_campaigns.go:243": urlValuesEntry(),
	"remote_access_review_campaigns.go:269": urlValuesEntry(),
	"remote_auth.go:352":                    urlValuesEntry(),
	"remote_break_glass.go:147":             urlValuesEntry(),
	...
	"remote_invitations.go:232":             urlValuesEntry(),
	"remote_invitations.go:416":             urlValuesEntry(),
	"remote_login_attempts.go:52":           urlValuesEntry(),
	"remote_machine_identities.go:329":      urlValuesEntry(),
	"remote_machine_identities.go:678":      urlValuesEntry(),
	"remote_memberships.go:197":             urlValuesEntry(),
	"remote_memberships.go:216":             urlValuesEntry(),
	"remote_memberships.go:233":             urlValuesEntry(),
	"remote_memberships.go:272":             urlValuesEntry(),
	...
	"remote_rbac.go:552":  pathEscapeEntry("url.PathEscape(connector) path-segment concatenation"),

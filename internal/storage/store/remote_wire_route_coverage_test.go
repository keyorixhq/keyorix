...
var knownUnresolvedWireCalls = map[string]wireCallExclusion{
	...
	"remote_dynamic.go:265":                 urlValuesEntry(),
	"remote_dynamic.go:353":                 urlValuesEntry(),
	"remote_dynamic.go:380":                 urlValuesEntry(),
	"remote_dynamic.go:413":                 urlValuesEntry(),
	...
	"remote_memberships.go:281":             urlValuesEntry(),
	"remote_mfa.go:135":                     urlValuesEntry(),
	"remote_mfa.go:218":                     urlValuesEntry(),
	"remote_secret_dependencies.go:146":     urlValuesEntry(),
	"remote_secret_dependencies.go:171":     urlValuesEntry(),
